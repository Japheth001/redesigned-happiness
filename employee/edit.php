 ...
 <div class="form-pack">
  <div class="editform">
		...
		<?php
				...
				$sql="SELECT * FROM `employee` WHERE username='$_SESSION[logon]'";
				...
				<input class="form-control" type="text" name="fullnames" value="<?php echo $last; ?>">
				...
				<br>
				<input style="margin-top: 5px;" class="form-control" type="text" name="contact" value="<?php echo $contact; ?>">
	  	...
	  	<?php
	  		if(isset($_POST['submit'])){
				...
				$sql1=("UPDATE employee SET pic='$pic', department='$_POST[department]',fullnames='$_POST[fullnames]',username='$_POST[username]',password='$_POST[password]',email='$_POST[email]',contact='$_POST[contact]' WHERE username='$_SESSION[logon]';");
...
<footer style="height: 50px; background-color: green;">
				<p style="text-align: center; font-size:12px; color: white; margin-top: 5px; padding-top: 8px;">
