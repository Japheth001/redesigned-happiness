...
<div class="container">
	...
	if($_SESSION['department']=='1'){
		...
		?>
		<h3 style="margin-top: -30px;">Assets at <?php
	echo  ""." "." ".$section;
...
WHERE quantity !='0' AND name LIKE '%$_POST[enter]%'");
	...
	echo "</table>";
		...
		$res=mysqli_query($db,"SELECT * FROM `assets` WHERE quantity !='0' AND department=$_SESSION[department]  ORDER BY `assets`.`id` DESC;");
