...
<a href="books.php">
	<h4 style="margin-left: 60px; margin-bottom: 10px">REQUEST OFFICE<br> EQUIPMENT</br></h4>
	<img src="images/logo14.png" alt="ADD SUBJECT"  title="REQUEST EQUIPMENT" style="width: 200px;">
</a>
...
<h4 style="margin-left: 60px; margin-bottom: 10px">MY BOOKS STATUS</h4>
	<img src="images/logo21.jpg" alt="ADD SUBJECT" title="VIEW STATUS" style="width: 200px;">
</a>	
</div>
