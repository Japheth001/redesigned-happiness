...
<div class="container">
	...
	<h3 style="margin-top: -50px;">Assets to Dispose</h3><br>
...
WHERE  status='2' AND name LIKE '%$_POST[enter]%'");
	...
	echo "</table>";
		...
		$res=mysqli_query($db,"SELECT * FROM `assets` WHERE status='2' ORDER BY `assets` .`id` DESC ;");
...
<span class="close">&times;</span>
	...
	<h3 style="text-align: center; font-size: 20px; color: red; font-size: 30px;"><b><span class="glyphicon glyphicon-car"><caption>Add_Product_to_Dispose</caption></span></b></h3>
		...
		<div style="margin-left: 150px;">
			...
			<br><br>
			<button class="btn btn-success" type="submit" name="disposebtn" style="width: 100px; height: 30px; margin-left: 300px; margin-top: 10px; background-color: olivedrab" >ADD</button>			
			<br><br><br><br><br><br>			
