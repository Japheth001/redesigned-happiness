...
<div class="wrapper">
<br>
	<a href="disposal.php"  div class="registersubB">
	


<h4 style="margin-left: 60px; margin-bottom: 10px">DISPOSE ASSET</h4>
	<img src="images/dispose6" alt="ADD SUBJECT"  title="DISPOSE ASSET" style="width: 180px; height: 160px;">
	
</div>


<div class="studentmarks" style="margin-top: -400px; margin-left: 545px;">
<a href="repair.php">
<h4 style="margin-left: 60px; margin-bottom: 10px">REPAIR ASSETS</h4>
	<img src="images/repair1.jpg" alt="ADD SUBJECT" title="REPAIR ASSET" style="width: 160px; height: 160px;">
</a>	
</div>



<div class="editmarks" style="margin-left: 850px; margin-top: -200px;">
<a href="transfer.php">
<h4 style="margin-left: 60px; margin-bottom: 10px">TRANSFER ASSETS</h4>
	<img src="images/transfer1.jpg" alt="EDIT SUBJECT" title="TRANSFER ASSETS" style="width: 180px; height: 160px;">
</a>	
</div>


<div class="reports" style="margin-left: 220px; margin-top: 20px;">
<a href="retain.php">
<h4 style="margin-left: 20px; margin-bottom: 3px">SERVICED ASSETS</h4>
	<img src="images/repair2.jpg" alt="EDIT SUBJECT" title="MANTAIN ASSETS" style="width: 180px; height: 130px;">
</a>	
</div>
...
<?php	
	 if(isset($_POST['backs'])){
		...
		<?php
	  		...
	  		<div class="back-buttons" style="margin-top: 35px; margin-left: 600px;">
