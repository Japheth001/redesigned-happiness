...
<div class="approve" id="picktask">
 ...
 <div class="approve" id="deleteoption" style="margin-top: -100px;margin-left: 800px;">
 <img src="images/delete4.jpg" style="width: 70px;height: 70px;">
 <p>Delete requests</p>
</div> 
  ...
  <?php	
	  	...
	  	<?php	
	  			if(isset($_POST['backb'])){
					?>
					<script>
	  				window.location="admin_taskspage.php";
	  				</script>
					<?php
				}	
 ...
 <form method="post" name="form1" action="">
 	<div style="margin-left: 150px;">
			...
			<br>				
						...
						<option value="5">Call for assistance</option>
...
if($_SESSION['department']=='1'){
	...
	?>
<h3 style="margin-top: 10px;"><b><p>Ongoing Tasks</p></b></h3> 
<br>
...
<?php
	...
	if(isset($_SESSION['logon'])){
		...
		<div>
			<br><br><br><br><input style="margin-left: 60px; width: 200px;" class="form-control" type="text" name="employee_name" placeholder="Task From" required="">
			<br>				
...
if(isset($_POST['picktask'])){
	$count=0;
	$check="SELECT * FROM support WHERE  employee_name='$_POST[employee_name]' ;";
	...
	mysqli_query($db,"UPDATE support SET approve = '$_POST[status]' WHERE employee_name='$_POST[employee_name]' AND id='$_POST[id]';");
...
<div class="endpoint" style="margin-top: -90px;">
		<?php
			include("footer.php");
		?>
</div>
