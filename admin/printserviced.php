...
<head>
<meta charset="utf-8">
<title>Print serviced assets</title>
</head>
<style type="text/css">
	.border-framing{
		width: 820px;
...
<div class="border-framing">
	<div>
	<iframe style="margin-left: 30px;background-color: white" src="http://kcaa/admin/print_admin_serviced.php" height="1000px" width="760px"></iframe> 
</div>
</div>
