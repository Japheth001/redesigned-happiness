...
<style>
	...
	<button onClick="window.print()" style="margin-top:20px">
		...
		<br>
		<div align="center"><b><span style="color: blue"><caption>REPORT ON SERVICED ASSETS </caption></span></b></div>
		<br>
		<div align="center">
		<?php
			$count=0;
			...
			$res=mysqli_query($db,"SELECT * FROM `assets` WHERE assets.status='4';");
			...
			if($count=='0'){
				echo "Currently no assets to be serviced";
			}else{
