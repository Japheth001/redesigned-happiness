...
<body >
 ...
 <?php
  ...
  <a class="h" href="requestbook.php">Book requested</a>
...
<h2><b><span>Add New Books</span></b></h2>
...
<form name="" action="" method="post">
		...
		<input class="form-control" type="text" name="edition" placeholder="Book Edition" required=""><br>
		...
		<button class="btn btn-default" style="background-color: pink" name="submit" value="submit" type="submit">ADD BOOK</button>
