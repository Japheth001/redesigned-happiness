...
<div class="prints" style="margin-left: 1150px; margin-top: -50px;">
	...
	<a href="printrepair.php">
	<img src="images/print3.jpg" style="margin-top: -10px; width: 85px; height: 85px;">
	</a>
	</form>
</div>
...
<div class="container">
	...
	<h3 style="margin-top: -50px;">Assets for repair</h3><br>
...
WHERE  status='3' AND name LIKE '%$_POST[enter]%'");
	...
	echo "</table>";
		...
		$res=mysqli_query($db,"SELECT * FROM `assets` WHERE status='3' ORDER BY `assets` .`id` DESC ;");
...
<span class="close">&times;</span>
	...
	<h3 style="text-align: center; font-size: 20px; color: red; font-size: 30px;"><b><span class="glyphicon glyphicon-car"><caption>Assets_for_Repair</caption></span></b></h3>
		...
		<div style="margin-left: 150px;">
			...
			<br>				
						...
						<option value="4">Serviced-Ready for use</option>
			...
			<br><br>
			<button class="btn btn-success" type="submit" name="repairbtn" style="width: 100px; height: 30px; margin-left: 300px; margin-top: 10px; background-color: olivedrab" >ADD</button>			
			<br><br><br><br><br><br>			
...
<?php
if(isset($_POST['repairbtn'])){
	$count=0;
	$check="SELECT * FROM assets WHERE assets.bid != '$_POST[productid]';";
