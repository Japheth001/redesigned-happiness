...
<nav class="navbar navbar-inverse">
	<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand active">KCAA INVENTORY MANAGEMENT SYSTEM</a>
			</div>
	...
	<?php
		...
		<ul class="nav navbar-nav">
					...
					<a href="profile.php"><span class="glyphicon glyphicon-info-sign" name="btnprofile">PROFILE</span></a>
				</li>
				
				<li>
					
					<a href="dashboard_adfinal.php"><span class="glyphicon glyphicon-dashboard" name="btnprofile">DASHBOARD</span></a>
				</li>
	...
	?>
				...
				<li><a href="admin-login.php"><span class="glyphicon  glyphicon-log-in"><br>LOGIN</span></a>
				</li>
