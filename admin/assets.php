...
WHERE assets.quantity=quantity>0 AND name LIKE '%$_POST[enter]%'");
	...
	echo "</table>";
		...
		<?php	
	  		...
	  		<div class="back-buttons" style="margin-top: 50px; margin-left: 530px;">
		...
		$res=mysqli_query($db,"SELECT * FROM `assets` WHERE assets.quantity=quantity>0 ORDER BY `assets`.`id` DESC;");
