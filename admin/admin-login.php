...
<section>
	<div class="log_img">
		...
		<br><br><br><br>
			...
			<h1 style="text-align: center; font-size: 20px; font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, 'sans-serif'">Admins Login Form</h1>
		...
		<br>
			...
			<div class="login">
				...
				<input class="btn btn-default" type="submit" name="submit_login" value="Login" style="width:70px; color: black; background-color: mediumseagreen"  >
				...
				<p style="color: white">
					...
					<a style="color: yellow; width: 50px" href="update_password.php">Forgot password ?</a><br><br>
				
					
					
					<div id="register_admin">
						New to this website ? &nbsp; &nbsp; <a style="color: yellow">Sign-Up</a>
					</div>
...
document.addEventListener("click", closeAllSelect);</script>
	...
	if(isset($_POST['submit_reg']))
	{
		...
		{
		mysqli_query($db,"INSERT INTO `admin`  VALUES ('$_POST[department]','$_POST[fullnames]','$_POST[username]',
