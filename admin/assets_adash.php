...
<style type="text/css">
	...
	background-image:url(images/bac-login4);
...
<div class="wrapper">
<br>
	<div class="registersubB" id="register_assets" >
	<a >


<h4 style="margin-left: 60px; margin-bottom: 5px; height: 10px; margin-top: 3px ">CIRCULATION ASSETS</h4>
	<img src="images/register4" alt="ADD SUBJECT"  title="ADD NEW ASSET" style="width: 200px;">
</a>	
</div>


<div class="studentmarks" id="viewmarks" style="margin-top: -230px">
<a href="deleteasset.php">
<h4 style="margin-left: 60px; margin-bottom: 5px">DE-REGISTER ASSETS</h4>
	<img src="images/deregister3.jpg" alt="ADD SUBJECT" title="DELETE ASSET" style="width: 200px;">
</a>	
</div>


<br><br><br>
<div class="editmarks" style="margin-top: -230px" >
<a href="requestasset.php">
<h4 style="margin-left: 60px; margin-bottom:10px;">HANDLE<br>REQUESTS</h4>
	<img src="images/request4.jpg" alt="EDIT SUBJECT" title="HANDLE REQUESTS" style="width: 180px; height: 100px;">
</a>	
</div>



<div class="editmarks" style="margin-top: -160px;margin-left: 830px;" >
<a href="#" id="issue_assets">
<h4 style="margin-left: 60px; margin-bottom:10px;">DIRECT<br>ISSUANCE</h4>
	<img src="images/request4.jpg" alt="EDIT SUBJECT" title="HANDLE REQUESTS" style="width: 180px; height: 100px;">
</a>	
</div>
<br><br>
...
<div class="reports">
<a href="issue_info">
<h4 style="margin-left: 20px; margin-bottom: 3px">REPORT ON<br> ISSUED ASSETS</h4>
	<img src="images/serviced1.jpg" alt="EDIT SUBJECT" title="ISSUED ASSETS" style="width: 180px; height: 130px;">
</a>	
</div>


<div class="reports" style="margin-left: 300px;margin-top: -180px">
<a href="assets.php">
<h4 style="margin-left: 60px; margin-bottom: -10px">VIEW ASSETS</h4><br>
	<img src="images/view1.jpg" alt="EDIT SUBJECT" title="VIEW ASSETS" style="width: 180px; height: 130px;">
</a>	
</div>



<div class="reports" style="margin-left: 600px;margin-top: -180px">
<a href="expired.php">
<h4 style="margin-left: 60px; margin-bottom: 3px">RETURN<br>ASSETS</h4>
	<img src="images/return4.jpg" alt="EDIT SUBJECT" title="VIEW ASSETS" style="width: 180px; height: 130px;">
</a>	
</div>
...
<?php	
	 if(isset($_POST['backs'])){
		...
		<?php
	  		...
	  		<div class="back-buttons" style="margin-top: 10px; margin-left: 600px;">
...
<span class="close">&times;</span>
	...
	<div style="margin-top: -25px;">
		<h3><b><span>Circulate New Assets In the Company</span></b></h3>
	...
	if(isset($_POST['submit'])){
		...
		$sql="INSERT INTO `assets`(`file`, `department`, `bid`, `name`, `date`, `supplier`,`location`, `status`, `quantity`, `transfer_to`) VALUES ('$pic', '$_POST[department]', '$_POST[bid]', '$_POST[name]', '$_POST[date]', '$_POST[supplier]','$_POST[location]', '$_POST[status]', '$_POST[quantity]', 'a');";
...
<span class="closes">&times;</span>
	...
	<script>
		...
		//Get the button that opens the modal
		var btns=document.getElementById("issue_assets");
		//Get the span element that closes the modal
