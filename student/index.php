...
<div class="wrapper" style="height: 500px;">
	...
	<nav>
		<ul>
			<li><a href="index.php"> HOME</a></li>
			<li><a href="books.php"> ASSETS</a></li>
			<li><a href="student-login.php">EMPLOYEE-LOGIN</a></li>
			<li><a href="registration.php">REGISTRATION</a></li>
			<li><a href="feedbacks.php">FEEDBACKS</a></li>
		</ul>
	</nav>
	...
	<section>
		...
		<div class="sec_imgstd" style="background-image:url(images/kcaa6.jpg); height: 480px; width: 1300px; background-image: no-repeat">
		<br><br><br><br><br><br><br><br><br>
			
			<div class="box11" style="margin-top: -100px" >
			
			
			<h1 style="text-align: center; font-size: 35px"> Welcome To Kcaa Inventory site</h1>
				<h1 style="text-align: center; font-size: 25px">Active</h1><br>
