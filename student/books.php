...
<form class="navbar-form" name="form2" method="post">
	<input class="form-control" type="text" name="enterid" placeholder="Enter book ID" required>
...
<h3>List of Books Available (Enter Book Id to Request)</h3>
...
?>
<!--------------------------------PHP Code to Request Book....................-->
<?php
	if(isset($_POST['request'])){
		if(isset($_SESSION['logon'])){
			mysqli_query($db,"INSERT INTO issue_book Values ('$_SESSION[logon]', '$_POST[enterid]', '', '', '');");
			?>
			<script type="application/javascript">
				window.location="requestbook.php";
			</script>
			<?php
		}else{
			?>
